...
export default function App({ serverGeneratedFileId }) {
  ...
  const handleClick = (e)=>{
   getUserLocation()
   setUserData({...userData, downloadRequested: false, downloadTimeStamp: new Date(),requestedFileId:  e.target.getAttribute(serverGeneratedFileId), browser: detect(), location: {ip: loc.ip, city: loc.city, country: loc.country}  })
   setToggle(!toggle)
